...
<form method="POST" enctype="multipart/form-data">
    <table align="center" class="table" style="width: auto; border-radius: 15px">
        ...
        <tr>
            <td>ngày</td>
            <td><input name="date" style="width: 280px" type="text" required value="<?php echo $product["date"]; ?>"></td>
        </tr>
        <tr>
            <td>Mô tả</td>
        ...
        <tr>
            <td>
                <a class="btn btn-warning" href="http://localhost/html/NAMbt/index.php">Trở về</a>
            </td>
            <td>
